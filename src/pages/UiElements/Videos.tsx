...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Savero - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Savero - React.js Tailwind CSS Admin Dashboard Template"
      />
