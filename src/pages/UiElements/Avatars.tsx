...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Savero - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Savero - React.js Tailwind CSS Admin Dashboard Template"
      />
